...
Version: 1.0.0
Author: Refinance Calculator / www.calculator.io
...
if (!function_exists('add_shortcode')) return "No direct call for Refinance Calculator by www.calculator.io";

function display_calcio_ci_refinance_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_refinance_calculator', 'display_calcio_ci_refinance_calculator' );